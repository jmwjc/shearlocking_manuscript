...
b(\delta \boldsymbol q,\boldsymbol u) &= f_{q}(\delta \boldsymbol q), & \forall \delta \boldsymbol q \in Q
\end{aligned}
\end{equation}
...
b( \boldsymbol q, \boldsymbol u) &= b_w(w, \boldsymbol q) + b_\varphi(\boldsymbol \varphi, \boldsymbol q) \\
