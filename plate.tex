...
\begin{rmk}
    As shown in Eq. \eqref{eq:weak_form_discrete}, there are two constraints in thick plate mixed formulation. One, as listed in third line of Eq. \eqref{eq:weak_form_discrete}, is a constraint mainly regarding the shearing force in entire domain. 
    The other is the shearing strain enforcement in whole domain.
    However, for the most of pioneer works, only consider the shearing strain constraint, and that is not sufficient for a satisfaction result.
\end{rmk}
