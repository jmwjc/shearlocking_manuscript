\section{LBB coefficient estimator} \label{sec:estimator}
...
\begin{equation}
    \inf_{p_h \in P_h} \sup_{u_h \in U_h} \frac{|b(u_h,p_h)|}{\| u \|_U \| p \|_P} \geq \beta
\end{equation}
...
Suppose that $U_{n_u} \subset U$ is a complete polynomial space with $\dim U_{n_u} = n_u$. The LBB coefficient $\beta$ can be estimated by:
\begin{equation}
...
\begin{equation}\label{eq:proof_1}
    \begin{aligned}
        \beta &\leq \inf_{p_h \in P_h} \sup_{u_h \in U_h} \frac{|(\mathcal P u_h,p_h)|}{\| u_h \|_U \| p_h \|_P} = \inf_{p_h \in P_h} \sup_{u_h \in U_h} \frac{|(\mathcal P_h u_h,p_h)|}{\| u_h \|_U \| p_h \|_P} \\
        &\leq \inf_{p_h \in \mathrm{Im} \mathcal P_h} \sup_{u \in U_h} \frac{|(\mathcal P_h u_h,p_h)|}{\| u_h \|_U \| p_h \|_P}
    \end{aligned}
\end{equation}
