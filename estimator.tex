...
\end{equation}
where $\mathcal I_h: U_{n_u} \to U_h$ is the interpolation operator with the characteristic size of the discretization $h$.
\end{thm}
\begin{pf}
...
\begin{equation}\label{eq:proof_1}
    ...
    \end{aligned}
\end{equation}
FIXME: the definition of image space can be canceled.
